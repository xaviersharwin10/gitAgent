...
> **Setup:** After installing with `npm install -g git-somnia-agent`, run `git config --global alias.somnia-agent '!git-somnia-agent'` to enable `git somnia-agent` commands.
